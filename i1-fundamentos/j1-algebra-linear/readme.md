...
1. **[codigo/i1-vetores.md](k3-implementacao/codigo/i1-vetores.md)** - Estruturas e operações
2. **[codigo/i2-matrizes.md](k3-implementacao/codigo/i2-matrizes.md)** - Multiplicação e operações
3. **[codigo/i3-transformacoes.md](k3-implementacao/codigo/i3-transformacoes.md)** - Aplicações práticas
4. **[codigo/i4-decomposicoes.md](k3-implementacao/codigo/i4-decomposicoes.md)** - Algoritmos avançados

**Código-fonte:** [k3-implementacao/codigo/src/](k3-implementacao/codigo/src/)
...
- [x] **Teoria (k1-teoria/)**
  - [x] t1-vetores-espacos.md
  - [x] t2-transformacoes-lineares.md
  - [x] t3-autovalores-autovetores.md
  - [x] t4-decomposicoes.md

- [x] **Exercícios (k2-exercicios/)**
  - [x] e1-vetores-exercicios.md (460 XP)
  - [x] e2-transformacoes-exercicios.md (480 XP)
  - [x] e3-autovalores-exercicios.md (520 XP)
  - [x] e4-decomposicoes-exercicios.md (595 XP)

- [x] **Implementação (k3-implementacao/codigo/)**
  - [x] i1-vetores.md (50 XP - pseudocódigo português)
  - [x] i2-matrizes.md (60 XP - pseudocódigo português)
  - [x] i3-transformacoes.md (75 XP - pseudocódigo português)
  - [x] i4-decomposicoes.md (90 XP - pseudocódigo português)

- [x] **Prática (k4-pratica/)**
  - [x] p1-basicos.md (300 XP - 3 problemas)
  - [x] p2-intermediarios.md (360 XP - 3 problemas)
  - [x] p3-avancados.md (400 XP - 3 problemas)

- [x] **Projeto (k5-projeto/)**
  - [x] Especificação completa (300 XP base)
  - [x] README detalhado com XP system
  - [x] Estrutura e controles definidos
...
- **j2-geometria-analitica** - Complementa com visão geométrica
